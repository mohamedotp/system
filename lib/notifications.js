 ...
 */
export async function sendNotification({ senderId, receiverId, message, docNo, title }) {
    ...
    try {
        ...
        try {
            ...
            await connection.execute(
                `INSERT INTO SYSTEM_NOTIFICATIONS (SENDER_ID, RECEIVER_ID, MESSAGE, DOC_NO, READ_FLAG) 
                 VALUES (:senderId, :receiverId, :message, :docNo, 0)`,
                {
